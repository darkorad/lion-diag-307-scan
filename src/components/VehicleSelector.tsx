              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Badge variant="outline">{selectedProfile.specificParameters.emissionStandard}</Badge>
                    ...
                    <Badge variant="outline">{selectedProfile.specificParameters.manufacturerProtocol}</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
